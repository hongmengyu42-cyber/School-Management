...
<aside class="sidebar">
    ...
    @if ($user?->isAdmin())
        ...
        <div class="nav-group">
            ...
            <a href="{{ route('admin.parent-links.index') }}" class="nav-link {{ request()->routeIs('admin.parent-links.*') ? 'active' : '' }}">Parent Links</a>
        </div>
        <div class="nav-group">
    ...
    @elseif ($user?->isTeacher())
        <div class="nav-group">
            ...
            <a href="{{ route('teacher.subjects.index') }}" class="nav-link {{ request()->routeIs('teacher.subjects.*') ? 'active' : '' }}">My Subjects</a>
    ...
    @elseif ($user?->isStudent())
        <div class="nav-group">
            ...
            <a href="{{ route('student.subjects.index') }}" class="nav-link {{ request()->routeIs('student.subjects.*') ? 'active' : '' }}">My Subjects</a>
            <a href="{{ route('student.grades.index') }}" class="nav-link {{ request()->routeIs('student.grades.*') ? 'active' : '' }}">Grades</a>
            <a href="{{ route('student.attendance.index') }}" class="nav-link {{ request()->routeIs('student.attendance.*') ? 'active' : '' }}">Attendance</a>
            <a href="{{ route('student.messages.index') }}" class="nav-link {{ request()->routeIs('student.messages.*') ? 'active' : '' }}">Messages</a>
            <a href="{{ route('student.enrollments.create') }}" class="nav-link {{ request()->routeIs('student.enrollments.*') ? 'active' : '' }}">Enroll</a>
        </div>
