    ...
    <div class="card">
        ...
        @if ($threads->isEmpty())
            <div class="empty-state">
                ...
                <p>Open a subject and tap "Message Teacher" to start a conversation.</p>
            </div>
        @else
            <table class="ledger">
                <thead><tr><th>Subject</th><th>Last message</th><th>Status</th><th></th></tr></thead>
                <tbody>
                    @foreach ($threads as $thread)
                        <tr>
                            ...
                            <td style="text-align:right;">
                                <a href="{{ route('student.messages.show', $thread) }}" class="btn btn-ghost btn-sm">Open</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
